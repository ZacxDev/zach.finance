 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query GetAssets($tickers: [String!]!, $fromDate: Int!, $toDate: Int!, $period: String!) {\n  getAssets(tickers: $tickers) {\n    ticker\n    name\n    trailingPERatio\n    pbRatio\n    roe\n    debtToEquityRatio\n    operatingMargin\n    earningsYield\n    freeCashFlowYield\n    marketCap\n    currentPrice\n    dividendYield\n    lastDividendDate\n    historicalPrices(from: $fromDate, to: $toDate, period: $period) {\n      date\n      close\n    }\n  }\n}"): (typeof documents)["query GetAssets($tickers: [String!]!, $fromDate: Int!, $toDate: Int!, $period: String!) {\n  getAssets(tickers: $tickers) {\n    ticker\n    name\n    trailingPERatio\n    pbRatio\n    roe\n    debtToEquityRatio\n    operatingMargin\n    earningsYield\n    freeCashFlowYield\n    marketCap\n    currentPrice\n    dividendYield\n    lastDividendDate\n    historicalPrices(from: $fromDate, to: $toDate, period: $period) {\n      date\n      close\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
